...
@section('content')
        ...
        <div class="container pt-4 mb-3 mb-lg-0">
            <div class="row">
                <div class="col-lg-5 col-md-6 col-sm-8">
                    <h5 class="text-light fw-normal">New game store PLAB</h5>
                    <h1 class="text-light mb-5">Enjoy games like never before</h1>
    ...
    <section>
        ...
        <div class="container pt-4 mb-3 mb-lg-0" style="text-align: center">
            <p style="font-size: 20px">Browse the latest games and add them to your wishlist</p>
        </div>
        </div>
    </section>
@endsection
